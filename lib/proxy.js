...
var keyboardInterceptor = true;
var mouseInterceptor = true;

var credentialsProvider = function (credentials) {
  credentials.keyboardInterceptor = keyboardInterceptor;
  credentials.mouseInterceptor = mouseInterceptor;
...
function addEventHandlers(r, socket) {
  ...
  function handleConnection(width, height) {
    ...
    socket.emit('init', {
      width: width,
      height: height,
      keyboardEnabled: client.keyboardInterceptor,
      mouseEnabled: client.mouseInterceptor
    });
